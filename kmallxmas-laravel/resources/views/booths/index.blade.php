            ...
            <div class="row g-2">
                <div class="col-md-3 col-sm-6 mb-1">
                    <div class="stat-box text-center p-2 border rounded">
                        <div class="stat-value text-primary fw-bold" style="font-size: 1.5rem;">{{ $totalBooths }}</div>
                ...
                <div class="col-md-3 col-sm-6 mb-1">
                    <div class="stat-box text-center p-2 border rounded bg-success bg-opacity-10">
                        <div class="stat-value text-success fw-bold" style="font-size: 1.5rem;">{{ $availableBooths }}</div>
                ...
                <div class="col-md-3 col-sm-6 mb-1">
                    <div class="stat-box text-center p-2 border rounded bg-info bg-opacity-10">
                        <div class="stat-value text-info fw-bold" style="font-size: 1.5rem;">{{ $bookedBooths }}</div>
                ...
                <div class="col-md-3 col-sm-6 mb-1">
                    <div class="stat-box text-center p-2 border rounded bg-warning bg-opacity-10">
                        <div class="stat-value text-warning fw-bold" style="font-size: 1.5rem;">{{ $reservedBoothsCount }}</div>
