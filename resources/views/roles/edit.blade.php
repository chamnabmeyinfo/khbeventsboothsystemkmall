...
@section('breadcrumb', 'Staff Management / Roles / Edit')

@section('content')
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-user-shield mr-2"></i>Edit Role: {{ $role->name }}</h3>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="sort_order" class="form-control" value="{{ old('sort_order', $role->sort_order) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
