        ...
        <form method="POST" action="{{ route('admin.events.update', $event) }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('start_date') is-invalid @enderror" 
                               ...
                               value="{{ old('start_date', $event->getAttributes()['start_date'] !== '0000-00-00' && $event->getAttributes()['start_date'] ? \Carbon\Carbon::parse($event->getAttributes()['start_date'])->format('Y-m-d') : '') }}" required>
                        @error('start_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('end_date') is-invalid @enderror" 
                               ...
                               value="{{ old('end_date', $event->getAttributes()['end_date'] !== '0000-00-00' && $event->getAttributes()['end_date'] ? \Carbon\Carbon::parse($event->getAttributes()['end_date'])->format('Y-m-d') : '') }}" required>
                        @error('end_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('seats') is-invalid @enderror" 
                               id="seats" name="seats" value="{{ old('seats', $event->seats) }}" min="1" required>
                        @error('seats')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('location_address') is-invalid @enderror" 
                          id="location_address" name="location_address" rows="2">{{ old('location_address', $event->location_address) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('short_description') is-invalid @enderror" 
                          id="short_description" name="short_description" rows="3">{{ old('short_description', $event->short_description) }}</textarea>
