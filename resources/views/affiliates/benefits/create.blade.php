...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-plus mr-2"></i>Create New Benefit</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('affiliates.benefits.store') }}" method="POST" id="benefitForm">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="target_revenue" class="form-control" 
                                       step="0.01" min="0" value="{{ old('target_revenue') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="target_bookings" class="form-control" 
                                       min="0" value="{{ old('target_bookings') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="target_clients" class="form-control" 
                                       min="0" value="{{ old('target_clients') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="min_revenue" class="form-control" 
                                       step="0.01" min="0" value="{{ old('min_revenue') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="max_benefit" class="form-control" 
                                       step="0.01" min="0" value="{{ old('max_benefit') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save mr-2"></i>Create Benefit
                    </button>
