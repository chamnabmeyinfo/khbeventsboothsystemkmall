...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0"><i class="fas fa-calendar-plus mr-2"></i>Create Leave Request</h1>
        ...
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="reason" name="reason" rows="4" placeholder="Please provide a reason for this leave request...">{{ old('reason') }}</textarea>
                </div>
            </div>
            <div class="card-footer">
                <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i>Submit Leave Request</button>
                <a href="{{ route('hr.leaves.index') }}" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </form>
</div>
