...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0">
            <i class="fas fa-user-edit mr-2"></i>Edit Employee: {{ $employee->full_name }}
        </h1>
...
<div class="container-fluid">
    <form action="{{ route('hr.employees.update', $employee) }}" method="POST" enctype="multipart/form-data">
        ...
        <!-- Same form structure as create, but with old values -->
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="probation_end_date" name="probation_end_date" 
                                   value="{{ old('probation_end_date', $employee->probation_end_date ? $employee->probation_end_date->format('Y-m-d') : '') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="currency" name="currency">
                                <option value="USD" {{ old('currency', $employee->currency) == 'USD' ? 'selected' : '' }}>USD</option>
                                <option value="KHR" {{ old('currency', $employee->currency) == 'KHR' ? 'selected' : '' }}>KHR</option>
                                <option value="EUR" {{ old('currency', $employee->currency) == 'EUR' ? 'selected' : '' }}>EUR</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <!-- Additional sections similar to create form -->
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="id_card_number" name="id_card_number" value="{{ old('id_card_number', $employee->id_card_number) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="emergency_contact_phone" name="emergency_contact_phone" value="{{ old('emergency_contact_phone', $employee->emergency_contact_phone) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
