...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0"><i class="fas fa-calendar-plus mr-2"></i>Create Leave Type</h1>
    ...
    <form action="{{ route('hr.leave-types.store') }}" method="POST">
        ...
        <div class="card card-primary card-outline">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="max_days_per_year" name="max_days_per_year" value="{{ old('max_days_per_year') }}" min="0">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="carry_forward" name="carry_forward" value="1" {{ old('carry_forward') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="is_paid" name="is_paid" value="1" {{ old('is_paid', true) ? 'checked' : '' }}>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i>Create Leave Type</button>
                <a href="{{ route('hr.leave-types.index') }}" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </form>
</div>
