...
@section('title', 'Create Revenue')
@section('page-title', 'Create Revenue')
@section('breadcrumb', 'Finance / Revenues / Create')

@section('content')
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-arrow-up mr-2"></i>Create New Revenue</h3>
        </div>
        <form action="{{ route('finance.revenues.store') }}" method="POST">
            @csrf
            <div class="card-body">
                @if($errors->any())
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" 
                                   required value="{{ old('title') }}" placeholder="Enter revenue title">
                            @error('title')
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                              rows="3" placeholder="Enter revenue description...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="revenue_date" id="revenue_date" class="form-control @error('revenue_date') is-invalid @enderror" 
                                   required value="{{ old('revenue_date', date('Y-m-d')) }}">
                            @error('revenue_date')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save mr-1"></i>Create Revenue
                </button>
