...
@section('title', 'Create Finance Category')
@section('page-title', 'Create Finance Category')
@section('breadcrumb', 'Finance / Categories / Create')
...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-tags mr-2"></i>Create New Finance Category</h3>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                   required value="{{ old('name') }}" placeholder="Enter category name">
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                ...
                                <option value="costing" {{ old('type') == 'costing' ? 'selected' : '' }}>Costing</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="color" name="color" id="color" class="form-control @error('color') is-invalid @enderror" 
                                       value="{{ old('color', '#667eea') }}" style="height: 38px;">
                                <input type="text" id="color_hex" class="form-control" 
                                       value="{{ old('color', '#667eea') }}" placeholder="#667eea" 
                                       pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$">
                            </div>
                            <span class="color-preview" id="color_preview" style="background-color: {{ old('color', '#667eea') }};"></span>
                            @error('color')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="sort_order" id="sort_order" class="form-control @error('sort_order') is-invalid @enderror" 
                                   min="0" value="{{ old('sort_order', 0) }}" placeholder="0">
                            @error('sort_order')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
