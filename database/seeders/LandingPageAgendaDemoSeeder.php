                ...
                'visual_content' => [
                    ...
                    'i18n' => [
                        'en' => [
                            ...
                            'agenda_days' => LandingPage::buildAgendaDaysFromItems(LandingPage::defaultDemoAgendaItems(), 'en'),
                        ],
                        'km' => [
                            'agenda_title' => 'កាលវិភាគដំណើរ',
                            'agenda_items' => $kmItems = self::agendaTextToItems(LandingPage::defaultDemoAgendaItemsText('km')),
                            'agenda_days' => LandingPage::buildAgendaDaysFromItems($kmItems, 'km'),
                        ],
                        'zh' => [
                            'agenda_title' => '行程表',
                            'agenda_items' => $zhItems = LandingPage::parseAgendaItemsFromText(LandingPage::defaultDemoAgendaItemsText('zh')),
                            'agenda_days' => LandingPage::buildAgendaDaysFromItems($zhItems, 'zh'),
                        ],
                    ],
                ],
            ]
