...
class CreateBoothRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'floor_plan_id.required' => 'Floor plan is required.',
    ...
    {
        // If no floor plan specified, we'll handle default in service
        if (empty($this->floor_plan_id)) {
            $this->merge(['floor_plan_id' => null]);
        }
    }
}
